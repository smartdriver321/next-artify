...
export const GET = async (req, { params }) => {
  try {
    ...
    if (!work) return new Response('The Work Not Found', { status: 400 })
  ...
  try {
    ...
    for (const photo of photos) {
      if (photo instanceof Object) {
        ...
        const workImagePath = `C:/Users/user/Documents/ecommerce_projects/next-artify/public/uploads/${photo.name}`
